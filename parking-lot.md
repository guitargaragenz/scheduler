...
- [ ] **Follow-up idea, not urgent** — split "job master data" (CSV/Sheet-driven) and "live schedule state" (app-driven: scheduled/calendarSlot/gcalEventId/pomoLog) into separate Firestore documents/fields, so this whole class of bug becomes structurally impossible instead of just carefully avoided via field-preservation logic. Root cause was Firestore storing both in one shared array with no partial-update support.
