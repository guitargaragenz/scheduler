...
| Brief | Date | Status |
|-------|------|--------|
| ~~[`.claude/pending-brief.md`](../../.claude/pending-brief.md)~~ | 2026-08-07 | **Closed 2026-08-08 — Build 2 shipped at `60ff7bf`.** No live scope lock right now. Old row: **This file is the scope lock for the revenue brief** (approved by Trevor 2026-08-07, council complete). It is the same work as the row below — read that row for where the build actually stands. Corrected 2026-08-08: this row previously described the blocked-work brief, whose Build 2 (the read-only Bench board) shipped 2026-08-05 at `7baa884` (PR #22). That work is finished; the scope lock moved on to revenue. |
