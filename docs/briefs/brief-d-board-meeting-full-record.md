...
> notes and live-test results. Brief D shipped and merged to `main` at `da1d9af` on
> 2026-07-25. Moved here so `.claude/pending-brief.md` holds only the brief currently
> awaiting approval. **History, not instructions.**
>
> One item in here was never completed and is now being paid back: scope item 4's third
> bullet, `days` (job age) has no Supabase column. See
> [../superpowers/plans/2026-07-27-job-blocking-implementation.md](../superpowers/plans/2026-07-27-job-blocking-implementation.md),
> Task 1.
